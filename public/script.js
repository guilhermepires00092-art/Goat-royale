...
// (Mesma lista do servidor para validação local)
const CLIENT_WORDS = [
    ...
    "DESTA", "DESTE", "DETER", "DEVER", "DEVEM", "DEVIR", "DIABO", "DIANTE", "DICAS", "DIETA",
    "DIGAM", "DIGNA", "DIGNO", "DIQUE", "DISCO", "DISSO", "DIULA", "DIVAS", "DIZER", "DIZEM",
    "DOBRA", "DOBRE", "DOCES", "DOCIL", "DOGMA", "DOIDO", "DOLAR", "DOMAR", "DONAS", "DORSO",
    "DOSE", "DOUTO", "DRAMA", "DROGA", "DROPS", "DUBIO", "DUELO", "DUETO", "DUNAS", "DUPLO",
    "DUQUE", "DURAS", "EBANO", "ECOAR", "EDEMA", "EDITA", "EGIDE", "EGITO", "EIVAI", "EIXOS",
    "ELEVA", "ELIDA", "ELIDE", "ELITE", "ELMOS", "EMAIL", "EMITA", "EMPOS", "ENCER", "ENFIM",
    "ENJOO", "ENSAR", "ENSEJO", "ENTAO", "ENTRA", "ENTRE", "ENVIA", "ENVIO", "EPICO", "EPIST",
    "EPOCA", "ERETO", "ERGAS", "ERROS", "ESCAL", "ESCOL", "ESCOE", "ESGAR", "ESMAA", "ESTAO",
    "ESTAR", "ESTIA", "ESTIO", "ETAPA", "ETICA", "ETICO", "ETNIA", "EXAME", "EXARA", "EXATA",
    "EXATO", "EXIBA", "EXIGE", "EXIJO", "EXIME", "EXITO", "EXODO", "EXPOR", "EXTRA", "FABRO",
    "FACAO", "FACIL", "FACAM", "FACTO", "FAINA", "FAIXA", "FALAR", "FALAS", "FALHA", "FALIR",
    "FALTA", "FALSO", "FAMOS", "FARAO", "FARDA", "FARDO", "FAROL", "FARPA", "FARTA", "FARTO",
    "FATAL", "FATOR", "FATOS", "FATUO", "FAUNA", "FAVOR", "FAZER", "FAZES", "FAZIA", "FEIAS",
    "FEIRA", "FEITA", "FEITO", "FEIXE", "FELIZ", "FENDA", "FERIR", "FEROZ", "FERPA", "FERRO",
    "FERVE", "FESTA", "FEUDO", "FIADO", "FIAIS", "FIAPO", "FICHA", "FICAR", "FIEIS", "FILAS",
    "FILHO", "FILME", "FINAL", "FINDA", "FINDO", "FINJO", "FINOS", "FINTA", "FIRMA", "FITA",
    "FITAR", "FIXAR", "FLORA", "FLUIR", "FLUXO", "FOCAO", "FOCAR", "FOFAS", "FOFOCA", "FOGAO",
    "FOLGA", "FOLHA", "FOLIA", "FOLIO", "FONTE", "FORA", "FORAM", "FORCA", "FOREM", "FORMA",
    "FORRO", "FORTE", "FOSCA", "FOSCO", "FOSSE", "FOSSO", "FRACO", "FRADE", "FRASE", "FREIO",
    "FRETE", "FREVO", "FRITA", "FROTA", "FRUTA", "FRUTO", "FUGAZ", "FUGIR", "FUGIU", "FUNDO",
    "FUNES", "FUNIL", "FURAR", "FURIA", "FUROU", "FUROR", "FUSCA", "FUTIL", "FUZIL", "GABAR",
    "GADUA", "GAIAS", "GALHO", "GAMA", "GANHO", "GARBO", "GARRA", "GASTO", "GATAS", "GEDAS",
    "GELO", "GEMA", "GEMER", "GENIO", "GENRO", "GENTE", "GERAI", "GERAL", "GERIA", "GERIR",
    "GESTO", "GINGA", "GIRAR", "GLEBA", "GLOBO", "GLOSA", "GOLFE", "GOLFO", "GOLPE", "GORRO",
    "GOSMA", "GOSTA", "GOSTO", "GRACA", "GRAMA", "GRANA", "GRATA", "GRATO", "GRAUS", "GRAVE",
    "GRIFO", "GRIPE", "GROTA", "GRUPO", "GRUTA", "GUETO", "GUIAR", "GUISA", "GUIZO", "GURIA",
    "HABIL", "HAREM", "HASTE", "HAURE", "HAVER", "HAVIA", "HEROI", "HIATO", "HIFEN", "HIENA",
    "HINOS", "HIRTO", "HOBBY", "HOMEM", "HONRA", "HORDA", "HORTA", "HORTO", "HOSTE", "HOTEL",
    "HOUVE", "HUMOR", "ICACO", "ICONE", "IDEAR", "IDEIA", "IDEAL", "IDOLA", "IDOLO", "IDONE",
    "IDOSO", "IGNEO", "IGNES", "IGUAL", "ILHAS", "ILESO", "IMITA", "IMPOR", "IMUNE", "INCHA",
    "INCOE", "INCAS", "INDEZ", "INDIO", "INGER", "INIBA", "INATO", "INTER", "INVES", "IOGUE",
    "IRADO", "IRIS", "IRMAO", "ISPIO", "ITENS", "JABOS", "JANTA", "JASPE", "JAULA", "JAZER",
    "JAZIA", "JECAS", "JEDAS", "JEITO", "JEJUM", "JEMBE", "JIPES", "JIRAU", "JOGAR", "JOGOS",
    "JOIAS", "JOVEM", "JUDEU", "JUIZA", "JUIZO", "JULGO", "JULIA", "JUNCO", "JUNTA", "JUROS",
    "JURIN", "JURAR", "JURIA", "JUROU", "JUSTA", "JUSTO", "LABIA", "LABOR", "LAGOS", "LAICO",
    "LAMBA", "LAMES", "LAMPA", "LANAR", "LAPIS", "LAPSO", "LARGO", "LARVA", "LASSO", "LATES",
    "LATIR", "LAUDO", "LAVRA", "LAVOR", "LAZER", "LEAIS", "LEGAL", "LEGUA", "LEIGO", "LEITE",
    "LEITO", "LENDA", "LENTO", "LESMA", "LESAO", "LESSE", "LESTO", "LETAL", "LETRA", "LEVAR",
    "LIAME", "LICAO", "LIDAR", "LIDER", "LIGAR", "LIMBO", "LIMPO", "LINDA", "LINDO", "LINHA",
    "LIRA", "LIRAS", "LIVRE", "LIVRO", "LIXAO", "LOCAO", "LOCAL", "LOCUS", "LOGAR", "LOGIA",
    "LOGOS", "LOGRA", "LOGRO", "LOIRA", "LOMBA", "LONGE", "LONGO", "LOTES", "LOUCA", "LOUCO",
    "LOUCA", "LOURO", "LUCRO", "LUGAR", "LUNAR", "LUTAR", "LUXAR", "LUXOS", "LUVAS", "MACAR",
    "MACAO", "MACIA", "MACIO", "MACRO", "MAGIA", "MAGNA", "MAGOA", "MAIOR", "MAJOR", "MALES",
    "MALHA", "MALSA", "MALTA", "MAMAE", "MANCO", "MANDA", "MANGA", "MANHA", "MANIA", "MANSA",
    "MANSO", "MANTO", "MAOME", "MARCA", "MARCO", "MARRA", "MASSA", "MATAR", "MATE", "MATIZ",
    "MEADA", "MEAO", "MECHA", "MEDIA", "MEDIR", "MEDOS", "MEIGA", "MEIGO", "MEIOS", "MEIAS",
    "MELAO", "MEMIS", "MENOR", "MENOS", "MERCÊ", "MESAS", "MESMA", "MESMO", "MESES", "METAL",
    "METIA", "METIE", "METRO", "MEXER", "MIDIA", "MILHA", "MILHO", "MIMAR", "MINAR", "MINHA",
    "MIOLO", "MIOPE", "MISSA", "MISTO", "MITOS", "MIXA", "MOCAS", "MOCAO", "MODA", "MODAL",
    "MOFOS", "MOIRA", "MOLDE", "MOLES", "MOLHO", "MONGE", "MONTA", "MONTE", "MORAL", "MORAR",
    "MORFO", "MORTE", "MORRO", "MORRE", "MOSTO", "MOTIM", "MOTOS", "MOVEL", "MOVER", "MUDAR",
    "MUITO", "MUNDO", "MURAL", "MUROS", "MURRA", "MUSEU", "MUSGO", "MUTUA", "MUTUO", "NACAO",
    "NACAR", "NADAR", "NADIR", "NAFTA", "NANOS", "NARCO", "NARIZ", "NARRA", "NASCE", "NATAL",
    "NATAS", "NAVAL", "NAVIO", "NEGAR", "NEGA", "NEGRO", "NENEM", "NESGA", "NESSA", "NESSE",
    "NESTA", "NESTE", "NETOS", "NEVE", "NICHO", "NIEVE", "NINFAS", "NINHO", "NIVEL", "NOBRE",
    "NOCAO", "NODOA", "NOITE", "NOIVA", "NOME", "NORMA", "NORTE", "NOSSA", "NOSSO", "NOTAR",
    "NOTAS", "NULAS", "NULOS", "NUNCA", "NUVEM", "NUDEZ", "OBESO", "OBICE", "OBITO", "OBRAS",
    "OBTER", "OBVIO", "OBSTA", "OCIOS", "OCREM", "OCASO", "ODIAR", "OITIS", "OLEO", "OLHAM",
    "OLHAR", "OLHOS", "ONDA", "ONCA", "ONTEM", "ONUS", "OPACO", "OPCAO", "OPIAM", "OPTAR",
    "OPTAS", "ORCAS", "ORDEM", "ORGAO", "ORNAR", "ORNES", "OSSO", "OSSOS", "OTICA", "OTICO",
    "OTIMO", "OUFAS", "OUCAS", "OURO", "OUSAR", "OUSAS", "OUTRA", "OUTRO", "OUVEM", "OUVIR",
    "OVAIS", "OXALA", "PACOS", "PACTO", "PADEI", "PAGAR", "PAGAO", "PAGUE", "PAIOL", "PAIRU",
    "PAIRA", "PALCO", "PALHA", "PAMPA", "PANCA", "PANGA", "PANOS", "PAPEL", "PARAR", "PARCO",
    "PARDA", "PARES", "PAREO", "PARIA", "PARTE", "PARVA", "PARVO", "PASMA", "PASMO", "PASSA",
    "PASSE", "PASSO", "PASTA", "PATAS", "PATIO", "PAUSA", "PAUTA", "PAZES", "PAVOR", "PECHA",
    "PEDIR", "PEDRA", "PEDRO", "PEGAR", "PEITA", "PEITO", "PEIXE", "PELOS", "PELVE", "PENA",
    "PENCA", "PENSO", "PENTA", "PENSO", "PERCO", "PERDA", "PERNA", "PERTO", "PERU", "PESAM",
    "PESAR", "PESCA", "PESTE", "PIADA", "PIAVA", "PICAR", "PICHE", "PIFAS", "PIFIO", "PILAR",
    "PILHA", "PINHO", "PINOS", "PINTA", "PIRAI", "PIRES", "PISAR", "PISTA", "PLACA", "PLAGA",
    "PLANA", "PLANO", "PLATO", "PLEBE", "PLENA", "PLENO", "PLUMA", "PLUMO", "PNEUS", "POCAS",
    "PODAR", "PODER", "PODIO", "POEMA", "POETA", "POLAR", "POLIS", "POMAR", "POMPA", "PONDE",
    "PONHA", "PONTE", "PONTO", "PORAO", "PORCA", "POREM", "PORTA", "PORTE", "POSAM", "POSSE",
    "POSSO", "POSTO", "POUCO", "POUSO", "PRACA", "PRADO", "PRAGA", "PRAIA", "PRATO", "PRAXE",
    "PRAZO", "PRECE", "PREGO", "PRECO", "PRESA", "PRESO", "PRETO", "PRIME", "PRIVE", "PROBO",
    "PROLE", "PROSA", "PROTO", "PROVA", "PRUMO", "PSICO", "PUDER", "PUDIM", "PUGNA", "PUIDO",
    "PULAR", "PULHA", "PUNHO", "PUNHA", "PUNES", "PURAS", "PURGA", "PUROS", "PUXAR", "QUAIS",
    "QUASE", "QUERO", "QUICA", "QUIETO", "QUILO", "QUOTA", "RACAM", "RACIO", "RADAR", "RADIO",
    "RAIAR", "RAIVA", "RAIO", "RALAR", "RAMOS", "RAMPA", "RANCO", "RANGO", "RANCO", "RAPAZ",
    "RAPTA", "RAROS", "RASOS", "RAZAO", "REACA", "REAGIR", "REATA", "RECEM", "RECUO", "REDOR",
    "REFEM", "REGER", "REGIO", "REGRA", "REINO", "RELES", "RELVA", "REME", "REMO", "RENDA",
    "RENTE", "REPOR", "RETER", "RETO", "RETRO", "RETER", "RETEM", "REVER", "REVES", "REZAR",
    "REZAS", "REZEI", "RICOS", "RIFAS", "RIGOR", "RIMA", "RISCO", "RISTE", "RITMO", "RITO",
    "ROCHA", "RODAS", "ROER", "ROGAR", "RONCA", "ROSAS", "ROTOS", "ROUCA", "ROUCO", "ROUPA",
    "RUBRO", "RUGE", "RUIDO", "RUIM", "RUINA", "RUMOR", "RUMO", "RURAL", "SABER", "SABIA",
    "SABIO", "SABOR", "SACAR", "SADIO", "SAGAO", "SAGAZ", "SAIAS", "SAIDA", "SAIRA", "SALDO",
    "SALMO", "SALSA", "SALTO", "SALVA", "SALVE", "SALVO", "SAMBA", "SANAR", "SANTO", "SAQUE",
    "SARAR", "SARAU", "SARCA", "SARGA", "SARJA", "SASSE", "SATIS", "SAUDA", "SAUDE", "SEARA",
    "SECAO", "SEGAR", "SEGUE", "SEIOS", "SEITA", "SEIVA", "SEIXO", "SELAR", "SELVA", "SENAO",
    "SENDA", "SENDO", "SENIL", "SENSO", "SENTA", "SENTE", "SERES", "SERIA", "SERIE", "SERRA",
    "SERVO", "SESTA", "SETAS", "SETOR", "SEXTA", "SEXTO", "SEXTA", "SICAR", "SIGLA", "SIGILO",
    "SIGNO", "SILVO", "SIMIO", "SINAL", "SINHA", "SINOS", "SINTO", "SIRVA", "SITIO", "SITUA",
    "SOBRE", "SOCAR", "SOCIO", "SODIO", "SOFAS", "SOFIA", "SOLAR", "SOLDA", "SOLDO", "SOLTA",
    "SOLTO", "SOMAR", "SONDA", "SONHO", "SONSA", "SONSO", "SOPRA", "SORRI", "SORTE", "SOSIA",
    "SOTAO", "SOVAR", "STAND", "SUADA", "SUAVE", "SUBIR", "SUCOS", "SUECO", "SUETA", "SUGAR",
    "SUGOU", "SUJOS", "SULCO", "SUMIR", "SUMO", "SUPER", "SUPOR", "SUPRA", "SURJA", "SURRA",
    "SURTO", "SUTIL", "SUTIA", "SWING", "TACAR", "TACAS", "TACAO", "TACHA", "TALAS", "TALAO",
    "TALCO", "TANGA", "TANGE", "TANTA", "TANTO", "TAPAR", "TARDE", "TARJA", "TATOS", "TAXAS",
    "TCHAU", "TECEL", "TECNO", "TECER", "TELAS", "TELHA", "TEMER", "TEMOR", "TEMOS", "TEMPO",
    "TENAZ", "TENDE", "TENDO", "TENIS", "TENRA", "TENRO", "TENSO", "TENTA", "TENTO", "TENUE",
    "TERAS", "TERCO", "TERMO", "TERNO", "TERRA", "TESAO", "TESTE", "TETRA", "TEXTO", "TIGRE",
    "TINHA", "TINTA", "TIRAR", "TICAO", "TITIO", "TIVER", "TOADA", "TOCAR", "TOCAS", "TODOS",
    "TODOS", "TOLOS", "TOMAR", "TONEL", "TONTO", "TOPAM", "TOPAR", "TOPO", "TOQUE", "TORCO",
    "TORNA", "TORPE", "TORSO", "TORTO", "TOSCO", "TOUCA", "TOURO", "TRACO", "TRAGA", "TRAGO",
    "TRAIR", "TRAJE", "TRAMA", "TRATO", "TRELA", "TRENS", "TRETA", "TREVA", "TREVO", "TRIBO",
    "TRIBUTO", "TRIGO", "TROCA", "TROCO", "TROLE", "TROPA", "TROCO", "TROCA", "TROCA", "TRUCO",
    "TRUPE", "TRUQUE", "TUAS", "TUBOS", "TUMBA", "TUNEL", "TURBA", "TURMA", "TURVA", "TURVO",
    "UBERE", "UIVOS", "UFANO", "UMAS", "UMEDO", "UMIDO", "UNIAO", "UNICA", "UNICO", "UNIDA",
    "UNIR", "URBAN", "URDIR", "URGIA", "URGIR", "URNAS", "USURA", "UTERO", "UTEIS", "VACUO",
    "VADIO", "VAGAR", "VAGAS", "VAGEM", "VAGUE", "VALER", "VALHA", "VALIA", "VALOR", "VALSA",
    "VARAO", "VARAR", "VARAS", "VAROA", "VARRE", "VASTA", "VASTO", "VAZAO", "VAZAS", "VAZIA",
    "VAZIO", "VEDAR", "VEDOU", "VELAM", "VELAR", "VELEI", "VELHA", "VELHO", "VELOZ", "VEMOS",
    "VENAL", "VENDA", "VENDO", "VENHA", "VENHO", "VENTO", "VENIA", "VERAO", "VERBA", "VERBO",
    "VERDE", "VERGA", "VERSA", "VERSO", "VERVE", "VETAR", "VETOR", "VEZES", "VICIO", "VIDAS",
    "VIDEO", "VIGIA", "VIGER", "VIGOR", "VILAO", "VIMOS", "VINHA", "VINHO", "VIRAM", "VIRAO",
    "VIRAR", "VIRIA", "VIRIL", "VIROU", "VIRUS", "VISAM", "VISAO", "VISAR", "VISSE", "VISTA",
    "VISTO", "VITAL", "VIUVA", "VIVAZ", "VIVER", "VOCAL", "VOILA", "VOLTA", "VOLTE", "VORAZ",
    "VOSSO", "VOTOS", "VULGO", "VULTO", "XALE", "XAMPU", "XEQUE", "XIBIU", "XINGA", "XISTO",
    "XUCRO", "ZANGA", "ZELAR", "ZELO", "ZIPER", "ZUMBI"
];
